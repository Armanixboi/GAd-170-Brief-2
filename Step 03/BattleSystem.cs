...
public class BattleSystem : MonoBehaviour
{
    ...
    IEnumerator DoRound()
    {
        ...
        else if (teamA.activeDancers.Count > 0 && teamB.activeDancers.Count > 0)
        {
            ...
            Character teamAcharacter = teamA.activeDancers[Random.Range(0, teamA.activeDancers.Count)]; // instead of null (nothing) we probably want a random charcter from each team.
        ...
        else
        {
            ...
            if (teamA.activeDancers.Count > 0)
            {
                ...
                winner = teamA; // null is the same as saying nothing...often seen as a null reference in your logs.
            }
            else
            {
                winner = teamB;
